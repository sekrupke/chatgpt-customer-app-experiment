...
# Final results
A minimal running Customer Application was created. The use cases Show, Create, Update, Delete were realized. Also, a basic validation for phone numbers was implemented.
